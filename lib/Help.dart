              ...
              child: Column(children: <Widget>[
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "TIGRAM is a web based application and mobile application developed for  private forest owner to apply for transit pass for exempted species of trees and  NOC for non-exempted species.",
                      style: TextStyle(
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "An applicant can apply for transit pass only after the Revenue Department  approves the application.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "An applicant has to register in the system, thereafter the applicant can apply  for a transit pass. Application will move to concerned Officers. After following  specific procedure of verification, Transit Pass will be issued. The applicant can  later download the transit pass generated from check pass status option.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The applicant can click on Register button on the home page of website. An applicant needs to register by entering personal details like name, email-id,  password, mobile number and id proof in the registration form. The applicant  can attach any one the below mentioned identity proofs. \n List Identity proof documents \n >  Aadhar card\n >  Driving License \n >  Passport\n >  Government ID\n > Voter Identity Card ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The applicant can login by entering registered email address and the  password which was set during registration. ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "A transit pass will be available for download from TIGRAM application for  7 days after the application is approved by forest range officer. ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "Yes you can take the print of your online transit pass, you can click on  download button link in check pass status to download the transit pass and  print the same.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The applicant can track the transit pass by clicking on the Check Pass  Status option which is seen on user dashboard once the applicant logs in  successfully. ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  child: ListTile(
                    title: const Text(
                      "Can a single Transit Pass generated or used for exempted and non exempted species ? ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.black),
                    ),
                    trailing: IconButton(
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "No. For exempted species NOC (No Objection Certificate) will be generated based on the application made by the applicant using Download  NOC link and for non-exempted species transit pass is generated.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "If an applicant wants to transport a species which is exempted as per  Forest Act and which does not require transit pass, but still as per Forest  Department rule transit of such timber will require an applicant to apply for  NOC for hassle free movement.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "To reset password, the applicant can click on Forgot password link on the  user login page, the applicant will be redirected to Change Password page, where  he can enter email address or mobile number used while registration and then  click on SEND OTP button. Lastly, he needs to enter the OTP received on the  registered email address or phone number click on VERIFY button. After  verification of OTP, enter a new password for login and then click on SAVE  button. The applicant can then login with the new password.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The TIGRAM application can be installed on the android version 6 to  android version 11 on the mobile phone. ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The application after being approved by the revenue department, if not  approved by the forest officer will be automatically approved by the system i.e. approved deemed approved after 20 days.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  child: ListTile(
                    title: const Text(
                      "How to enter wood log details? Is it mandatary to enter wood log details ? ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.black),
                    ),
                    trailing: IconButton(
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The applicant can click on the Yes button after the question “Would you  like to enter log Details?” and enter the length, girth and click on location icon  to set the latitude and longitude of the wood log. The volume of the log is  automatically calculated by the system. No, it is not mandatory to enter the  wood log details. ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The applicant click on location icon to set the latitude and longitude of the  wood log. After the location icon is clicked, the applicant will be directed to a  map where the applicant can zoom in or pan to set the latitude and longitude of  the trees. There is a marker on the map which will be displaying the location of  the trees.",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
                ...
                Card(
                  ...
                  child: const ListTile(
                    title: Text(
                      "The applicant can click on the logout button which is placed on the top  right corner of the website and can tap on the three lined icon on mobile  application and click on Log out option in left side menu bar on mobile  application. ",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Colors.blue),
                    ),
                  ),
